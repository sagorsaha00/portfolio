      ...
      >
        ...
        <div className="relative px-5 pb-12 md:px-10">
          ...
          <animated.div
            ...
            className="absolute -top-20 left-1/2 -translate-x-1/2 md:left-10 md:translate-x-0"
          >
            <div className="relative">
              <div className="absolute inset-0 scale-110 rounded-full bg-orange-500/20 blur-2xl" />

              <img
                src="/sagor-saha.jpg"
                alt="Sagor"
                className="relative h-[160px] w-[160px] rounded-full border-[6px] border-[#140707] object-cover shadow-[0_0_40px_rgba(249,115,22,0.35)]"
              />
            </div>
          </animated.div>
          ...
          {/* INFO */}
          <div className="mt-8 text-center md:mt-2 md:ml-[190px] md:text-left">
            <div className="flex flex-wrap items-center justify-center gap-3 md:justify-start">
              <h1 className="text-4xl font-black tracking-tight text-white md:text-6xl">
                Sagor Saha
              </h1>

              <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg">
                ✓
              </span>
            </div>
          ...
          {/* STATS */}
          <div className="mt-12 w-full grid gap-5 sm:grid-cols-3 flex  justify-between">
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 text-center backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-orange-400/30">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7 text-center backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-orange-400/30">
              <p className="bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text  font-black text-transparent">
                Unlimented
              </p>
